...
Public Class rptImprimirSalida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptImprimirSalida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImprimirSalida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImprimirSalida = New rptImprimirSalida()
        rpt.Site = Me.Site
        Return rpt
    End Function
