    ...
    Sub Lista(ByVal Fecha1 As DateTime, ByVal Fecha2 As DateTime, Optional ByVal IDBodega As String = "", Optional ByVal IDSerie As String = "", Optional ByVal NEmpleado As String = "", Optional ByVal Empleado As String = "", Optional ByVal NCliente As String = "", Optional ByVal Cliente As String = "")
        Try
            Using db As New CodeFirst
                Dim consulta = (((From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE IsNot Nothing And ven.CLIENTE.N_CLIENTE.Contains(NCliente) And (ven.CLIENTE.NOMBRES & " " & ven.CLIENTE.APELLIDOS).Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.SUBTOTAL_C, (det.SUBTOTAL_D * Config.exchangeRate))), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C, det.IVA_DIN_TOTAL_D * Config.exchangeRate)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C, det.TOTAL_D * Config.exchangeRate)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL - DESCUENTO).ToList).Union((From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE Is Nothing And NCliente = "" And ven.CLIENTECONTADO.Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.SUBTOTAL_C + det.DESCUENTO_DIN_TOTAL_C, (det.SUBTOTAL_D * Config.exchangeRate) + (det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate))), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C, det.IVA_DIN_TOTAL_D * Config.exchangeRate)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C, det.TOTAL_D * Config.exchangeRate)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).ToList)).ToList
                If Config.currentBusiness.MonedaInventario.Equals(Config.cordoba) Then
                    If rdContado.Checked Then
                        consulta = (From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And Not ven.CREDITO And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE IsNot Nothing And ven.CLIENTE.N_CLIENTE.Contains(NCliente) And (ven.CLIENTE.NOMBRES & " " & ven.CLIENTE.APELLIDOS).Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.SUBTOTAL_C, (det.SUBTOTAL_D * Config.exchangeRate))), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C, det.IVA_DIN_TOTAL_D * Config.exchangeRate)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C, det.TOTAL_D * Config.exchangeRate)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).Union(From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And Not ven.CREDITO And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE Is Nothing And NCliente = "" And ven.CLIENTECONTADO.Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.SUBTOTAL_C + det.DESCUENTO_DIN_TOTAL_C, (det.SUBTOTAL_D * Config.exchangeRate) + (det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate))), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C, det.IVA_DIN_TOTAL_D * Config.exchangeRate)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C, det.TOTAL_D * Config.exchangeRate)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).ToList
                    ...
                    End If
                Else
                    consulta = (From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE IsNot Nothing And ven.CLIENTE.N_CLIENTE.Contains(NCliente) And (ven.CLIENTE.NOMBRES & " " & ven.CLIENTE.APELLIDOS).Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C / Config.exchangeRate, det.DESCUENTO_DIN_TOTAL_D)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), (det.SUBTOTAL_C / Config.exchangeRate), det.SUBTOTAL_D)), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C / Config.exchangeRate, det.IVA_DIN_TOTAL_D)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C / Config.exchangeRate, det.TOTAL_D)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL - DESCUENTO).Union(From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE Is Nothing And NCliente = "" And ven.CLIENTECONTADO.Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.SUBTOTAL_C + det.DESCUENTO_DIN_TOTAL_C, (det.SUBTOTAL_D * Config.exchangeRate) + (det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate))), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C, det.IVA_DIN_TOTAL_D * Config.exchangeRate)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C, det.TOTAL_D * Config.exchangeRate)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).ToList
                    If rdContado.Checked Then
                        consulta = (From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And Not ven.CREDITO And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE IsNot Nothing And ven.CLIENTE.N_CLIENTE.Contains(NCliente) And (ven.CLIENTE.NOMBRES & " " & ven.CLIENTE.APELLIDOS).Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), (det.SUBTOTAL_C / Config.exchangeRate), det.SUBTOTAL_D)), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C / Config.exchangeRate, det.IVA_DIN_TOTAL_D)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C / Config.exchangeRate, det.TOTAL_D)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).Union(From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And Not ven.CREDITO And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE Is Nothing And NCliente = "" And ven.CLIENTECONTADO.Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.SUBTOTAL_C + det.DESCUENTO_DIN_TOTAL_C, (det.SUBTOTAL_D * Config.exchangeRate) + (det.DESCUENTO_DIN_TOTAL_D * Config.exchangeRate))), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C, det.IVA_DIN_TOTAL_D * Config.exchangeRate)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C, det.TOTAL_D * Config.exchangeRate)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).ToList
                    ElseIf rdCredito.Checked Then
                        consulta = (From pro In db.Productos Join exi In db.Existencias On pro.IDPRODUCTO Equals exi.IDPRODUCTO Join det In db.VentasDetalles On exi.IDEXISTENCIA Equals det.IDEXISTENCIA Join ven In db.Ventas On ven.IDVENTA Equals det.IDVENTA Join ser In db.SERIES On ven.IDSERIE Equals ser.IDSERIE Join bod In db.Bodegas On ser.IDBODEGA Equals bod.IDBODEGA Where ven.ANULADO = "N" And ven.FECHAFACTURA >= Fecha1 And ven.FECHAFACTURA <= Fecha2 And bod.IDBODEGA.Contains(IDBodega) And ser.IDSERIE.Contains(IDSerie) And ven.CREDITO And ven.Empleado.N_TRABAJADOR.Contains(NEmpleado) And (ven.Empleado.NOMBRES & " " & ven.Empleado.APELLIDOS).Contains(Empleado) And ven.IDCLIENTE IsNot Nothing And ven.CLIENTE.N_CLIENTE.Contains(NCliente) And (ven.CLIENTE.NOMBRES & " " & ven.CLIENTE.APELLIDOS).Contains(Cliente) Group By pro.IDALTERNO, pro.DESCRIPCION Into COSTOTOTAL = Sum(det.COSTO * det.CANTIDAD), CANTIDAD = Sum(det.CANTIDAD), DESCUENTO = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.DESCUENTO_DIN_TOTAL_C, det.DESCUENTO_DIN_TOTAL_D)), SUBTOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), (det.SUBTOTAL_C / Config.exchangeRate), det.SUBTOTAL_D)), IVA = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.IVA_DIN_TOTAL_C / Config.exchangeRate, det.IVA_DIN_TOTAL_D)), TOTAL = Sum(If(ven.MONEDA.Equals(Config.cordoba), det.TOTAL_C / Config.exchangeRate, det.TOTAL_D)) Select IDALTERNO, DESCRIPCION, COSTOPROMEDIO = COSTOTOTAL / CANTIDAD, COSTOTOTAL, PRECIOPROMEDIO = SUBTOTAL / CANTIDAD, CANTIDAD, DESCUENTO, SUBTOTAL, IVA, TOTAL, UTILIDAD = SUBTOTAL - COSTOTOTAL).ToList
                    End If
                End If
