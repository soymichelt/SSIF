...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddTableActivities
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddTableActivities))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201804172153313_AddTableActivities"
            End Get
        End Property
