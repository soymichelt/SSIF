...
BEGIN
	...
	BEGIN
		(SELECT 
			...
			SUM(CASE Compra.MONEDA WHEN 'C' THEN CompraDetalle.DESCUENTO_DIN_TOTAL_C / @TazaCordoba ELSE CompraDetalle.DESCUENTO_DIN_TOTAL_D * @TazaDolar END) AS Descuento,
			SUM(CASE Compra.MONEDA WHEN 'C' THEN CompraDetalle.SUBTOTAL_C / @TazaCordoba ELSE CompraDetalle.SUBTOTAL_D * @TazaDolar END) AS SubTotal,
			SUM(CASE Compra.MONEDA WHEN 'C' THEN CompraDetalle.IVA_DIN_TOTAL_C / @TazaCordoba ELSE CompraDetalle.IVA_DIN_TOTAL_D * @TazaDolar END) AS Iva,
			SUM(CASE Compra.MONEDA WHEN 'C' THEN CompraDetalle.TOTAL_C / @TazaCordoba ELSE CompraDetalle.TOTAL_D * @TazaDolar END) AS Total
		FROM
			Producto
