...
Public Class rptInformeVendedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeVendedor = New rptInformeVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
