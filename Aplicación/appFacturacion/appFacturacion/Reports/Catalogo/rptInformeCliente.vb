...
Public Class rptInformeCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeCliente = New rptInformeCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
