...
Public Class rptInformeFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeFactura = New rptInformeFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
