...
Public Class rptInformeSalida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeSalida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeSalida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeSalida = New rptInformeSalida()
        rpt.Site = Me.Site
        Return rpt
    End Function
