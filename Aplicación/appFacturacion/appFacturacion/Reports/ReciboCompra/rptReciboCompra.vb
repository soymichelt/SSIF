...
Public Class rptReciboCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptReciboCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboCompra = New rptReciboCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
