...
Public Class rptInformeCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeCompra = New rptInformeCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
