...
Public Class rptImprimirEntrada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptImprimirEntrada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImprimirEntrada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImprimirEntrada = New rptImprimirEntrada()
        rpt.Site = Me.Site
        Return rpt
    End Function
