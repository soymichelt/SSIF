...
Public Class rptInformeEntrada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeEntrada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeEntrada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeEntrada = New rptInformeEntrada()
        rpt.Site = Me.Site
        Return rpt
    End Function
