...
Public Class rptImprimirTraslado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptImprimirTraslado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptImprimirTraslado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImprimirTraslado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImprimirTraslado = New rptImprimirTraslado()
        rpt.Site = Me.Site
        Return rpt
    End Function
