...
Public Class rptInformeTraslado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptInformeTraslado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeTraslado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeTraslado = New rptInformeTraslado()
        rpt.Site = Me.Site
        Return rpt
    End Function
