...
Public Class rptValuacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptValuacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptValuacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptValuacion = New rptValuacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
