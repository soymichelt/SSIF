...
Public Class rptControlExistencia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptControlExistencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appFacturacion.rptControlExistencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptControlExistencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptControlExistencia = New rptControlExistencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
