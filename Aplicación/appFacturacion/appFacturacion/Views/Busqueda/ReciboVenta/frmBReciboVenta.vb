        ...
        If dtRegistro.SelectedRows.Count > 0 Then
            Try
                Using db As New CodeFirst
                    ...
                    Dim v = db.RECIBOS.Where(Function(f) f.IDRECIBO = idrecibo).FirstOrDefault()
